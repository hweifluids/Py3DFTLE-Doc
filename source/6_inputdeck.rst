...
.. table:: Numerical methods in the input deck ``.par`` file.

  =============================================== ============================== ==================== ====================================================================================================
  Key                                             Description                    Value(s)             Explanation
  =============================================== ============================== ==================== ====================================================================================================
  ``if_backward``                                 Backward integration flag      ``0``                Only compute forward advection.
                                                  (continued)                    (``1``)              Compute in both side.
  ...
  ``advc_method``                                 Lagrangian advection scheme    (``Euler``)          Simple and fast Euler stepping with
                                                  (continued)                    ``RK2``              Runge–Kutta 2 with :math:`O(h^3)` error.
                                                  (continued)                    ``RK4``              Runge–Kutta 4 with :math:`O(h^4)` error
                                                  (continued)                    ``RK6``
  ``interp_method``                               Interpolation method           ``<string>``         
  ``grad_order``                                  Gradient approximation scheme  ``<int>``            
  ``Eigen_method``                                Eigenvalue computation method  ``<string>``           
